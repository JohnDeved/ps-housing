...
CREATE TABLE IF NOT EXISTS `properties` (
    ...
    `owner_citizenid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    ...
    `apartment` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL, -- if NULL then it's a house
